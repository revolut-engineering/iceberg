...
public class CheckSnapshotIntegritySparkAction extends BaseSparkAction<CheckSnapshotIntegrity>
  ...
  final private Consumer<String> validateFunc =
      new Consumer<String>() {
        @Override
  ...
  public CheckSnapshotIntegritySparkAction(SparkSession spark, Table table) {
    super(spark);
    this.table = table;
  }
